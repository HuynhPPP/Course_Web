        ...
        <div class="col-xl-12 mx-auto">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form id="AddCategoryForm" action="{{ route('update.category') }}" method="post" class="row g-3"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="input1" name="category_name"
                                placeholder="First Name" value="{{ $category->category_name }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset($category->image) }}" alt="Admin" id="showImage"
