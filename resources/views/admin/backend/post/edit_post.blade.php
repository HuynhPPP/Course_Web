    ...
    <div class="col-xl-12 mx-auto">
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="AddCategoryForm" action="{{ route('update.blog.post') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="blogCategory_id" class="form-select mb-3" aria-label="Default select example">
                            ...
                            @foreach ($blog_cat as $cat)
                                <option value="{{ $cat->id }}"
                                        {{ $cat->id == $post->blogCategory_id ? 'selected' : '' }}
                                >
                                    {{ $cat->category_name }}
                                </option>
                            @endforeach
