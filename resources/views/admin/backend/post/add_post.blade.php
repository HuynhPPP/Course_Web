    ...
    <div class="col-xl-12 mx-auto">
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="AddCategoryForm" action="{{ route('store.blog.post') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-md-12">
                        <label for="input1" class="form-label">Post Descreption</label>
                        <textarea class="form-control textarea" 
                                  name="long_descreption"
                        >
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input name="post_tags" type="text" class="form-control" data-role="tagsinput" value="jQuery">
                    </div>
