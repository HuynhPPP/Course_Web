            ...
            <div class="breadcrumb-content">
                ...
                <div class="d-flex flex-wrap align-items-center pt-3">
                    ...
                    <div class="rating-wrap d-flex flex-wrap align-items-center">
                        ...
                        @php
                            $enrollmentCount = App\Models\Order::where('course_id',$course->id)
                                                               ->count();
                        @endphp
                       ...
                       <div class="instructor-wrap">
                           <div class="media media-card">
                               <div class="instructor-img">
                                   <a href="teacher-detail.html" class="media-img d-block">
                                       <img class="lazy" 
                                            ...
                                            data-src="images/small-avatar-1.jpg" 
                                            alt="Avatar image">
                                   </a>
                               ...
                               <div class="media-body">
                                   <h5><a href="teacher-detail.html">{{ $course->user->username }}</a></h5>
                               ...
                               <div class="media-body">
                                ...
                                @php
                                    ...
                                    for ($i=5; $i >= 1; $i--) { 
                                        ...
                                        $persent = $totalReviews > 0 ? ($count / $totalReviews) * 100 : 0;
                                        $percentTages[] = [
                                            'rating' => $i,
                                            'percent' => $persent,
                                            'count' => $count,
                                ...
                                @endphp
                                    ...
                                    @if (count($percentTages) > 0)
                                        @foreach ($percentTages as $ratingInfo)
                            ...
                            @foreach ($relatedCourses as $relatedCourse)
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                    <a href="{{ url('course/details/'.$relatedCourse->id.'/'.$relatedCourse->course_name_slug) }}" class="media-img">
                                        <img class="mr-3 lazy" 
                                             src="{{ asset($relatedCourse->course_image) }}" 
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="d-block lh-18 py-1 fs-14">{{ $relatedCourse->user->username }}</span>

                                        @if ($relatedCourse->discount_price == NULL)
                                            <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $relatedCourse->selling_price }}</p>
                                        @else
                                            <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $relatedCourse->selling_price }} 
                                                <span class="before-price fs-14">${{ $relatedCourse->discount_price }}</span></p>
                                        @endif
...
<section class="related-course-area bg-gray pt-60px pb-60px">
    <div class="container">
        <div class="related-course-wrap">
            <h3 class="fs-28 font-weight-semi-bold pb-35px">More Courses by <a href="teacher-detail.html" class="text-color hover-underline">{{ $course->user->username }}</a></h3>
            <div class="view-more-carousel-2 owl-action-styled">

                @foreach ($instructorCourses as $instructorCourse)

                @php
                    $amount = $instructorCourse->selling_price - $instructorCourse->discount_price;
                    $discount = ($amount/$instructorCourse->selling_price) * 100;
                @endphp

                    <div class="card card-item">
                        <div class="card-image">
                            <a href="{{ url('course/details/'.$instructorCourse->id.'/'.$instructorCourse->course_name_slug) }}" class="d-block">
                                <img class="card-img-top" src="{{ asset($instructorCourse->course_image) }}" alt="Card image cap">
                            </a>
                            <div class="course-badge-labels">
                                ...
                                @if ($instructorCourse->discount_price == NULL)
                        ...
                        <div class="card-body">
                            <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{ $instructorCourse->label }}</h6>
                            <h5 class="card-title">
                                <a href="{{ url('course/details/'.$instructorCourse->id.'/'.$instructorCourse->course_name_slug) }}">
                                    {{ $instructorCourse->course_name }}
                                </a>
                            </h5>
                            <p class="card-text"><a href="teacher-detail.html">{{ $instructorCourse['user']['name'] }}</a></p>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if ($instructorCourse->discount_price == NULL)
                                    <p class="card-price text-black font-weight-bold">${{ $instructorCourse->selling_price }}</p>
                                @else
                                    <p class="card-price text-black font-weight-bold">${{ $instructorCourse->discount_price }} 
                                        <span class="before-price font-weight-medium">${{ $instructorCourse->selling_price }}</span></p>
                                @endif
