                ...
                <div class="course-dashboard-column">
                    <div class="lecture-viewer-container">
                        <div class="lecture-video-item">
                            <iframe width="100%" height="700" id="videoContainer" src=""
                                            ...
                                            <div class="lecture-overview-stats-wrap d-flex">
                                                ...
                                                <div class="lecture-overview-stats-item">
                                                    <ul class="generic-list-item">
                                                        <li><span>Skill level:</span>{{ $course->course->resources }}
                                                        </li>
                                    ...
                                    <div class="lecture-overview-wrap lecture-quest-wrap">
                                        <div class="new-question-wrap">
                                            ...
                                            <div class="new-question-body pt-40px">
                                                ...
                                                <form action="{{ route('user.question') }}" class="pt-4" method="POST">
                                                    @csrf
                                        ...
                                        <div class="question-overview-result-wrap">
                                            <div class="lecture-overview-item">
                                                <div
                                                    ...
                                                    <h3 class="fs-17 font-weight-semi-bold">{{ count($all_question) }} questions in this course
                                                    </h3>
                                                    <button
                                                ...
                                                <div class="question-list-item">
                                                    ...
                                                    @foreach ($question as $que)
                                                        ...
                                                        @foreach ($reply as $rep)
                                                            <div class="media media-card border-bottom border-bottom-gray py-4 px-3" style="background: #f7f7ff ">
                                                                <div class="media-img rounded-full flex-shrink-0 avatar-sm">
                                                                    <img class="rounded-full" 
                                ...
                                @foreach($section as $sec)
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header" id="heading{{ $sec->id }}">
                                                                        <button class="btn btn-link" type="button" data-toggle="collapse"
                                                                            data-target="#collapse{{ $sec->id }}" aria-expanded="true"
                                                                    ...
                                                                    <div id="collapse{{ $sec->id }}" class="collapse"
                                                                        aria-labelledby="heading{{ $sec->id }}" data-parent="#accordionCourseExample">
                                                                        <div class="card-body p-0">
                                                                            <ul class="curriculum-sidebar-list">
