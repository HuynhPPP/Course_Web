    ...
    <div class="bg-gray py-5">
        <div class="container">
            <ul class="nav nav-tabs generic-tab justify-content-center" id="myTab" role="tablist">
                ...
                @else
                    <button class="btn theme-btn d-none d-lg-inline-block mr-2">For chat login first</button>
                @endauth
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center pb-1">
                        ...
                        <p class="text-success fs-14 font-weight-medium">Updated
                            <span class="font-weight-bold pl-1">{{ $item->created_at->format('M d Y') }}</span>
                        </p>
