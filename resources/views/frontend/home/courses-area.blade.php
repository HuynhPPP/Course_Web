...
<section class="course-area pb-120px">
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="business-tab" data-toggle="tab" href="#business{{ $category->id }}" role="tab" aria-controls="business" aria-selected="false">
                            ...
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{ $course->id }}">
                                <div class="card-image">
                                    <a href="{{ url('course/details/'.$course->id.'/'.$course->course_name_slug) }}" class="d-block">
                                        <img class="card-img-top lazy" src="{{ asset($course->course_image) }}" data-src="{{ asset('frontend/') }}images/img8.jpg" alt="Card image cap">
                                    </a>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center pb-1">
                    ...
                    <p class="text-success fs-14 font-weight-medium">Updated
                        <span class="font-weight-bold pl-1">{{ $item->created_at->format('M d Y') }}</span></p>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <button type="submit" 
                            ...
                            onclick="addToCart({{ $item->id }}, '{{ $item->course_name }}', 
