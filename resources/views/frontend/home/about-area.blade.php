        ...
        <div class="row">
            ...
            <div class="col-lg-5 ml-auto">
                <div class="generic-img-box">
                    <img src="{{ asset('frontend/images/img-loading.png') }}" data-src="images/img13.jpg" alt="About image"
                        class="img__item img__item-1 lazy">
                    <img src="{{ asset('frontend/images/img-loading.png') }}" data-src="images/img14.jpg" alt="About image"
